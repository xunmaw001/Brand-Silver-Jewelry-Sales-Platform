<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="饰品编号" prop="shipinbianhao">
          <el-input v-model="ruleForm.shipinbianhao" 
              placeholder="饰品编号" clearable  :readonly="ro.shipinbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="饰品编号" prop="shipinbianhao">
              <el-input v-model="ruleForm.shipinbianhao" 
                placeholder="饰品编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="饰品名称" prop="shipinmingcheng">
          <el-input v-model="ruleForm.shipinmingcheng" 
              placeholder="饰品名称" clearable  :readonly="ro.shipinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="饰品名称" prop="shipinmingcheng">
              <el-input v-model="ruleForm.shipinmingcheng" 
                placeholder="饰品名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="饰品类型" prop="shipinleixing">
          <el-input v-model="ruleForm.shipinleixing" 
              placeholder="饰品类型" clearable  :readonly="ro.shipinleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="饰品类型" prop="shipinleixing">
              <el-input v-model="ruleForm.shipinleixing" 
                placeholder="饰品类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
